...
function make_html_column(target_team, team_data, max_point) {
    ...
    team_name = '<div class="short box ' + target_team + '">' + target_team + '</div>\n';
    var box_list = [];
    ...
    space_cols = max_point - team_data.avlbl_pt;
...
function render_bar_graph() {
    ...
    insert_point_columns = make_insert_columns(inputs.category);
    point_column = make_point_column(inputs.max_point);
