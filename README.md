...
![image](https://user-images.githubusercontent.com/84721916/124415935-dd22b300-dd90-11eb-8717-ba9aeb3bc63b.png)

どんな試合で、どんな点差で負けたっけ、みたいな振り返りにどうぞ。(見たくない時もあるかもしれませんが)  

ここには、近い将来表示に合わせて現在または表示時点の、勝ち点、最大勝ち点、得点、失点、得失点差なども表示させる予定です。
